...
import 'package:memelord/views/screens/components/cancel_button.dart';
import 'package:memelord/views/screens/components/login_form.dart';
import 'package:memelord/views/screens/components/register_form.dart';
      ...
      body: Stack(
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color.fromARGB(255, 15, 231, 247),
                  ),
                )
              ),
              ...
              RegisterForm(isLogin: isLogin,
               animationDuration: animationDuration, 
               size: size, defaultLoginSize: defaultRegisterSize, 
               emailController: emailController, 
               passwordController: passwordController,
